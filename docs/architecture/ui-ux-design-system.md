# JSPlayground UI/UX 디자인 시스템 설계서
...
### 브랜드 컨셉
- **PlayfulLearning**: 재미있는 학습 경험
- **TechFriendly**: 개발자들에게 친숙한 느낌
- **Modern**: 세련되고 현대적인 디자인

### 브랜드 키워드
- Playful, Interactive, Smart, Accessible, Modern
...
#### Primary Colors
- **Brand Primary**: 바이올렛 계열 (코딩의 신비로움 표현)
- **Brand Secondary**: 블루 계열 (신뢰성과 안정감)
- **Accent**: 그린 계열 (성공과 성장 표현)

#### Semantic Colors
- **Success**: 그린 - 정답, 완료, 성취
- **Warning**: 오렌지 - 주의, 힌트, 중간 단계
- **Error**: 레드 - 오답, 에러, 실패
- **Info**: 블루 - 정보, 가이드, 설명

#### Neutral Colors
- **Gray Scale**: 9단계 그레이 스케일
- **Background**: 라이트/다크 모드 각각 3단계
- **Text**: Primary, Secondary, Disabled 텍스트
...
각 게임별 고유 컬러 테마 적용
- Closure Cave: 보라/금색 (신비로운 동굴)
- Promise Battle: 파랑/빨강 (전투적 분위기)
- CallStack Library: 갈색/베이지 (도서관 느낌)
...
- **Code Font**: JetBrains Mono (코드 에디터)
- **Display Font**: Poppins (헤딩, 타이틀)
